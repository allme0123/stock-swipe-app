...
# v23: exact current-price label, narrower ticker column, chart scroll lock and multi-select filters.
#
# Run:
...
function toggleExpand(ticker) {
    ...
    if (opening) {
        setTimeout(() => {
            ...
            setTimeout(() => {
                if (state.expandedTicker === ticker) tableShell.classList.add('chart-open');
            }, 380);
        }, 80);
    }
}
