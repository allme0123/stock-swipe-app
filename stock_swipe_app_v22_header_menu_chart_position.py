# stock_swipe_app_v22_header_menu_chart_position.py
# Mobile-first ASX stock table with sticky columns, sortable headers,
# inline expandable charts, watchlists and action menus.
# v22: mobile top safe-space, unobscured action menus and chart alignment.
#
# Run:
#   pip install streamlit pandas openpyxl yfinance
#   streamlit run stock_swipe_app_v22_header_menu_chart_position.py
...
function toggleExpand(ticker) {
    ...
    if (opening) {
        setTimeout(() => {
            ...
            /* Put the selected ticker immediately under the fixed headings.
               The newly opened chart then occupies the centre of the screen,
               rather than centring the ticker and leaving the chart below it. */
